    ...
    <body className="main-content">
      <div className="nes-container with-title is-centered is-rounded is-faq">
        ...
        <section className="how-to-section">
          ...
          <p>
            2. Choose the amount you would like to bet from the following
            options: 0.1, 0.25, 0.5 and 1 Solana{" "}
          ...
          <p>
            5. Once you have initiated the bet you will be placed into the
            betting queue against all other players who have chosen the same bet
            total. If there is someone already waiting in the betting queue you
            will instantly be matched against them.
          </p>
